...
class TermsOfUse extends Component {
        ...
        const trans = {
            address: (() => {
                switch (window.location.host) {
                    ...
                    case 'indacoin.com':
                    default:
                        return 'indacoin.com +44 207 048 25 82. Indacoin Limited, Suite 4b, 43 Berkeley Square, Mayfair, London, Westminster, United Kingdom, W1J 5FJ';    
                }                            
            })(),
            addr: (() => {
                switch (window.location.host) {
 ...
 <div className='wrapperTerms'>
                ...
                >
                    <p>If you have any feedback, questions, or complaints, write us an email to support@indacoin.com or contact an agent via online chat on our webpage https://{{ host: trans.host }}.</p>
