      ...
      <div className="reviewRow">
        <div className="reviewBlock">
          <div className="reviewTop" style={{ paddingBottom: 5 }}>
            <div>
              <img className="reviewImg" alt='avatar' style={{ width: "66px", height: "66px", marginBottom: "1rem" }} src={Alexandro} />
            </div>
            <div style={{ padding: "0.5rem" }}>
              <div className="main__text" style={{ marginLeft: 10, marginBottom: 1 }}>Alexandro A</div>
              <div className="infoTop">
                <div style={{ display: "flex", marginLeft: 10 }}>
                  <img src={locationReview} alt='location icon' style={{ marginRight: 5, marginTop: 2 }} width={13} height={13} />
          ...
          <div className="reviewRating">
            <div className="starsBlock">
              <img src={blueStar} alt='stars point' width={21} />
              <img src={blueStar} alt='stars point' width={21} />
              <img src={blueStar} alt='stars point' width={21} />
              <img src={blueStar} alt='stars point' width={21} />
              <img src={blueStar} alt='stars point' width={21} />
